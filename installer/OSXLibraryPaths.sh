...
install_name_tool -change /usr/local/lib/libwx_osx_cocoau_xrc-3.1.dylib @executable_path/../Frameworks/librtmidi.2.1.0.dylib ProximaController.app/Contents/MacOS/ProximaController
